	...
	<script>
		document.addEventListener("DOMContentLoaded", function() {
			const chartConfigs = [{
					...
					colors: [window.theme.primary, window.theme.warning, window.theme.danger]
				},
				{
					id: 'doughnutChart2',
			...
			function updateCharts(data) {
				...
				Object.keys(chartInstances).forEach(chartId => {
					...
					const chartData = data[chartId.replace('doughnutChart', '').toLowerCase()];
			...
			const evtSource = new EventSource('chart_updates.php');
